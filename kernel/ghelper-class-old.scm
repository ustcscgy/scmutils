...
#|
 ...
 ;Value 14: #[compound-procedure 14 operator]
 ...
 (pp (get-operator-record foo))
 (3 (a (b . two-arg-a-b)) (b . one-arg-b) . foo)
 ...
 (pp (get-operator-record foo))
 (3 (a (b . two-arg-a-b) . one-arg-a) (b . one-arg-b) . foo)
 ...
 (pp (get-operator-record foo))
 (3 (a (b . two-arg-a-b) . one-arg-a-prime) (b . one-arg-b) . foo)
 ...
 (pp (get-operator-record foo))
 (3 (a (b . two-arg-a-b-prime) . one-arg-a-prime) (b . one-arg-b) . foo)
 ...
 (3 (x (y (z . three-arg-x-y-z)))
    (a (b . two-arg-a-b-prime) . one-arg-a-prime)
    (b . one-arg-b)
    .
    foo)
