...
(assign-operation 'zero-like (linear-memoize-1arg o:zero-like) simple-operator?)
(assign-operation 'one-like o:one-like operator?)
(assign-operation 'identity-like o:one-like operator?)

(assign-operation '+          (linear-memoize o:+)       operator? operator?) 
(assign-operation '+          (linear-memoize o:o+f)     operator? not-operator?) 
(assign-operation '+          (linear-memoize o:f+o)     not-operator? operator?) 
...
(assign-operation 'negate     (linear-memoize-1arg o:negate)           operator?)
(assign-operation 'expt       (linear-memoize o:expt)    operator? exact-integer?)

(assign-operation 'exp        (linear-memoize-1arg o:exp)              operator?)
(assign-operation 'sin        (linear-memoize-1arg o:sin)              operator?)
(assign-operation 'cos        (linear-memoize-1arg o:cos)              operator?)
